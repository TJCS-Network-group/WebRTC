...
function startRecording() {
  ...
  timer = setInterval(() => {
    recordtime += 10;
    console.log("have recorded", Math.floor(recordtime / 60), "minute", recordtime % 60, "second");
...
function endRecording() {
  ...
  clearInterval(timer);
  fs.writeFileSync("1.webm", cameraBuffer);
  fs.writeFileSync("2.webm", screenBuffer);
}
